...
reset:
  ...
  lda #$30 ; Farge på slangen
  sta snake_color
  
  ; Initialiser slangens posisjon
  lda #$20 ; X posisjon til slangen
  sta snake_x
  lda #$30 ; Y posisjon til slangen
  sta snake_y
  
  lda #$A8 ; Farge på bakgrunnen, RRGG BB--, 10101000
  sta bakgrunn_farge

; -------------------------------------------------  
  ; Fyll skjermen med bakgrunnsfargen
  ldx #$64 ; Start på x verdi 64 (40 hex)
  ldy #$40 ; Start på y verdi 100 (64 hex)
